var Pix8acc = {
  ...
  init: function(){
    ...
    $('<span>', {id: 'pix8-logout'}).html('&#10006;').appendTo($acc).click(function(){
      t.out();
      Cookies.remove(Cfg.sidCookie);
    });

    $auth = $('<div>', {id: 'pix8-auth', class: 'na'}).appendTo('#pic').text('auth');
  ...
  initEvents: function(){
    $('#pix8-fullName, #pix8-auth').click(function(){
      Pix8acc.toggleAuth();
    });
  },
